...
(function(factory) {
	...
	Rating.prototype = {
		...
		_generateRating: function() {
			...
			self.$rating = $rating = $(document.createElement("div")).attr('class', 'rating-stars')
				.appendTo($container)
		...
		_renderClear: function() {
			...
			self._addContent('clear',
				'<div class="' + css + '" title="' + self.clearButtonTitle + '">' + self
				.clearButton + '</div>');
		...
		_initEvents: function() {
			...
			self.events = {
				_getTouchPosition: function(e) {
					var pageX = $h.isEmpty(e.pageX) ? e.originalEvent.touches[0].pageX : e
					.pageX;
				...
				clearMouseMove: function(e) {
					...
					self.clearClicked = false;
					caption = '<span class="' + self.clearCaptionClass + '">' + self
						.clearCaption + '</span>';
					val = self.clearValue;
				...
				clearMouseLeave: function(e) {
					var out;
					if (self.events._noMouseAction(e) || self.clearClicked || !self
						.hoverOnClear) {
						return;
					}
					out = self.cache;
	...
	$.fn.rating = function(option) {
		...
		this.each(function() {
			...
			if (!data) {
				...
				opts = $.extend(true, {}, $.fn.rating.defaults, thm, $.fn.ratingLocales.en, loc,
					options, self.data());
	...
	$.fn.rating.defaults = {
		...
		clearCaptionClass: 'label label-success',
		clearValue: null,
		captionElement: null,
		clearElement: null,
		hoverEnabled: true,
