...
public class Provider {
    ...
    public String batchDelete(@Param("session_id") Integer session_id, @Param("SeatIdList") List<Seat> SeatIdList) {
        ...
        str.append("delete seat_selected from seat_selected left join orders on seat_selected.session_id=orders.session_id where orders.order_status=3 and seat_selected.session_id=");
